        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,1.1fr)] lg:items-center lg:gap-14 xl:gap-20">
          <div>
            ...
            <div className="mt-6 space-y-4 max-w-xl text-base leading-relaxed text-[#5E686D]">
              <p>
                At <strong className="font-semibold text-[#171715]">Leader Gate</strong>, we create powerful brand experiences through strategic design, precision fabrication, and flawless execution. As a leading UAE signage, branding, and fabrication company, we deliver complete visual solutions that help businesses establish a stronger and more memorable presence.
              </p>
              <p>
                From <strong className="font-semibold text-[#171715]">concept development and manufacturing to professional installation and ongoing support</strong>, our dedicated teams combine advanced machinery, experienced craftsmanship, and meticulous project management to deliver exceptional results.
              </p>
            </div>
